...
public class ProjectTeamMemberOutputDto {
    ...
    private List<ProjectTeamMemberDetailDto> projectTeamMemberDetailDtoList;
    ...
    public List<ProjectTeamMemberDetailDto> getProjectTeamMemberDetailDtoList() {
        return projectTeamMemberDetailDtoList;
    }

    public void setProjectTeamMemberDetailDtoList(List<ProjectTeamMemberDetailDto> projectTeamMemberDetailDtoList) {
        this.projectTeamMemberDetailDtoList = projectTeamMemberDetailDtoList;
    }

    public static class ProjectTeamMemberDetailDto {
